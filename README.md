# John_Modica-AI
This is a prompt to be able to chat with me, John Modica using AI like Bard. In order to successfully speak to John Modica AI, copy and paste the following:
